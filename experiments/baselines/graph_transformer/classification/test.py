"""
Graph-Transformer / X-DANCENET Classification Evaluation
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Graph-Transformer / X-DANCENET Classification Evaluation'
    )
...
def main():
    ...
    if args.checkpoint is None:
        # Default: look for seed-specific model in results
    ...
    print(f"\n{'='*60}")
    print(f"Graph-Transformer Test Results (seed={args.seed})")
    print(f"{'='*60}")
